#!/usr/bin/env python3
"""
Main orchestrator script for Guardian crossword downloader.
...
from guardian_downloader import GuardianDownloader
from supernote_client import SuperNoteClient
